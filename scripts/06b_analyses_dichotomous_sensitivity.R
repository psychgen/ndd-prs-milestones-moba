...
load( file = './data/sensitivity_06_vars.RData')
...
ys <- c( "motor", "motor_spec", "lang", "lang_spec", 
         "adhd", "adhd_spec",  "asd","asd_spec", "early_wlk", 
         "late_wlk", "early_wds", "late_wds", "early_sns", "late_sns", 
         "slow_rate", "fast_rate")
...
save(fitcomps_out,fitcomp_best,fitcomps_rsq,rsqs_bysex, file = "./scratch_data/sensitivty_analyses_fitcomps.RData")
...
save(ests3_tab, file="./scratch_data/sens_analyses_ests_pre_mtc.RData")
